...
if (!empty($errors)) {
    ...
    $update = "UPDATE `tbl_user` SET `username`='".$user."',`email`='".$email."',`first_name`='".$fname."',`middle_name`='".$mname."',`last_name`='".$lname."',`phone`='".$contact."',`add_street`='".$street."',`add_barangay`='".$barangay."',`add_city`='".$city."',`add_province`='".$province."',`timestamp_update`='".$date."', `active`='".$status."' WHERE id = '".$id."'";
