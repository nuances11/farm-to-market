                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 input-productcategory">
                                    <select class="form-control" name="productCategory" id="productCategory">
                                        ...
                                        <option value="Category 1" <?php if ($prod[ 'prod_category']=='Category 1' ){echo 'selected';} ;?>>Category 1</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 input-productsubcategory">
                                    <select class="form-control" name="productSubCategory" id="productSubCategory">
                                        <option value="">Please select...</option>
                                        <option value="Sub-category 1" <?php if ($prod[ 'prod_subcategory']=='Sub-category 1' ){echo 'selected';} ;?>>Sub Category 1</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
