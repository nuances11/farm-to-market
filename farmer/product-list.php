        ...
        <div class="pull-right">
            <div class="btn-group">
                <button type="button" class="btn btn-default btn-outline">
                    <img src="../build/images/flags/us.jpg" alt="" class="flag-icon">English</button>
                <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-default btn-outline dropdown-toggle">
                ...
                <ul class="dropdown-menu dropdown-menu-right animated fadeInDown">
                    <li>
                        <a href="#">
                            <img src="../build/images/flags/de.jpg" alt="" class="flag-icon">German</a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="../build/images/flags/fr.jpg" alt="" class="flag-icon">French</a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="../build/images/flags/es.jpg" alt="" class="flag-icon">Spanish</a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="../build/images/flags/it.jpg" alt="" class="flag-icon">Italian</a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="../build/images/flags/jp.jpg" alt="" class="flag-icon">Japanese</a>
                    </li>
                </ul>
            </div>
        </div>
