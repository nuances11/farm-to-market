    ...
    <!-- Malihu Scrollbar-->
    <script type="text/javascript" src="<?= BASE_URL ?>assets/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
    <!-- Animo.js-->
    <script type="text/javascript" src="<?= BASE_URL ?>assets/animo.js/animo.min.js"></script>
    <!-- Bootstrap Progressbar-->
    <script type="text/javascript" src="<?= BASE_URL ?>assets/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
    <!-- jQuery Easy Pie Chart-->
    <script type="text/javascript" src="<?= BASE_URL ?>assets/jquery.easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
    <!-- Toastr-->
    <script type="text/javascript" src="<?= BASE_URL ?>assets/toastr/toastr.min.js"></script>
    <!-- MomentJS-->
    <script type="text/javascript" src="<?= BASE_URL ?>assets/moment/min/moment.min.js"></script>
    <!-- jQuery BlockUI-->
    <script type="text/javascript" src="<?= BASE_URL ?>assets/blockUI/jquery.blockUI.js"></script>
    <!-- jQuery Counter Up-->
    ...
    <!-- FullCalendar-->
    <script type="text/javascript" src="<?= BASE_URL ?>assets/fullcalendar/dist/fullcalendar.min.js"></script>
    <!-- jQuery MiniColors-->
    <script type="text/javascript" src="<?= BASE_URL ?>assets/jquery-minicolors/jquery.minicolors.min.js"></script>
    ...
    <script type="text/javascript" src="<?= BASE_URL ?>custom/farmer.js"></script>
