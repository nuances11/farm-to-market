        ...
        <ul class="notification-bar list-inline pull-right">
            <li class="dropdown">
                ...
                <div aria-labelledby="dropdownMenu1" class="dropdown-menu dropdown-menu-right dm-medium fs-12 animated fadeInDown">
                    <h5 class="dropdown-header">Profile Setting</h5>
                    <ul data-mcs-theme="minimal-dark" class="media-list mCustomScrollbar">
                        <li class="media">
                            <a href="edit-profile.php?id=<?= $_SESSION['id'] ?>">
                            <div class="media-left avatar"><i class="glyphicon glyphicon-cog"></i></span></div>
                        ...
                        <li class="media">
                            <a href="logout.php">
                            <div class="media-left avatar"><i class="ti-power-off"></i></span></div>
                            <div class="media-body">
