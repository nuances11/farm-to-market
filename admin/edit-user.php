            ...
            <div class="widget-body">
                    ...
                    <form id="edit-profile-form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            if ($user['birthday']) {
                                list($month, $day, $_year) = explode('-', $user['birthday']);
                            }
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select id="status" name="status" class="form-control">
                                    ...
                                    <option value="0" <?php if($user['active'] == '0'){echo 'checked';} ?>>Inactve</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-6">
                            <a href="javascript:void(0)" id="delete-user" data-id="<?= $user['id'] ?>" class="pull-right" style="color:red;"><small>Permanently Delete User</small></a>
                                <button type="button" id="edit-profile" class="btn btn-raised btn-black">Submit</button>
                                <a href="index.php" class="btn btn-raised btn-default">Back</a>
